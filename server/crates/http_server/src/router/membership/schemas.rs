...
pub const MEMBERS_TAG: &str = "membership";
pub const MEMBERS_PATH: &str = "/membership";
pub const MEMBER_BY_ID_PATH: &str = "/membership/{ident}";
pub const MEMBER_SUSPENSION_PATH: &str = "/membership/{ident}/suspension";
pub const MEMBER_LOANS_PATH: &str = "/membership/{ident}/loans";
