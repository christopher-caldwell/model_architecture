# TypeScript CQRS Application Layer

## Purpose
Guide a model through the typescript cqrs application layer part of migrating the confirmed Rust modular library demo to idiomatic Node / TypeScript without changing behavior or architectural boundaries.
...
For **TypeScript CQRS Application Layer**, preserve the exact confirmed Rust names and behavior where this skill touches them. If this skill needs details not listed above, inspect the repository again and add only confirmed facts.
