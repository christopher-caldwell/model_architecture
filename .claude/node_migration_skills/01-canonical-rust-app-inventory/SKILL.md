# Canonical Rust App Inventory

## Purpose
Guide a model through the canonical rust app inventory part of migrating the confirmed Rust modular library demo to idiomatic Node / TypeScript without changing behavior or architectural boundaries.
...
For **Canonical Rust App Inventory**, preserve the exact confirmed Rust names and behavior where this skill touches them. If this skill needs details not listed above, inspect the repository again and add only confirmed facts.
